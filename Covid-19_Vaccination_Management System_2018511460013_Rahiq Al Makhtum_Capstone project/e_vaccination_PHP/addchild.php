...
<center><h1 >Add Patient Details</h1></center>

<label><b>Patient's Full Name</b></label></br>
...
<label ><b>Patient City</b></label></br>
<select name="ccity">
...
<label ><b>Patient's Birth Date </b></label></br>
	<input type="date" name="cbirth" />
</br></br>

<label><b>Patient Age </b></label> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
<label><b>Patient Weight </b></label>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
<label><b>Patient Height </b></label><br>
...
?>
<br>
<center><input type="Submit" name="addchild" value="Add Patient"/></center>
...
<?php
	...
	if(isset($_POST['addchild']))
	{
		...
		echo "<script>alert('Add Your Patient Details..!!');window.location='parentindex.php'</script>";
	}
?>
